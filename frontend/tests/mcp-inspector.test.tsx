...
vi.mock("@/lib/mcp-api", () => ({
  ...
  getMCPPolicy: vi.fn().mockResolvedValue({ id: "policy-1", tenant_id: "tenant-1", user_id: "user-1", server_id: "server-1", allowed_tools: [], denied_tools: [], read_only: true, risk_ceiling: "read", approval_rules: {}, tool_modes: {}, default_enabled: false, deepspace_overrides: {}, conversation_overrides: {}, created_at: "2026-07-20T00:00:00Z", updated_at: "2026-07-20T00:00:00Z" }),
  getMCPTools: vi.fn().mockResolvedValue({ tools: [{ name: "search_mail", description: "Search", category: "Read", risk_labels: ["read"], mode: "always_allow" }] }),
  getMarketplaceEntry: vi.fn().mockResolvedValue({ id: "provider-1", requested_scopes: ["mail.read"], scope_note: null }),
