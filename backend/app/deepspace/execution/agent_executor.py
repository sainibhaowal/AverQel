...
from app.deepspace.execution.reliability import CircuitBreaker
...
from app.deepspace.runtime.runtime_hooks import (
    RuntimeHooks,
    summarize_runtime_hooks_state,
)
from app.deepspace.runtime.runtime_policy import (
    RuntimePolicy,
    summarize_runtime_policy_state,
)
from app.deepspace.workspace.coding_harness import CodingHarness, CodingMissionContract
                    ...
                    if mission_snapshot and mission_snapshot.get("full_autonomy"):
                        try:
                            if checkpoint_registry.schedule_continuation(checkpoint_mission_id):
                                from app.deepspace.workers.tasks import (
