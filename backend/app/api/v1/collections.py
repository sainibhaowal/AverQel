...
from app.schemas.documents.collection import (
...
def add_permissions(
    ...
    from app.models.documents.collection import CollectionPermission as DBCollectionPermission
...
def get_collection_chats(
    ...
    if collection and collection.expiry_days > 0:
        ...
        from app.models.documents.collection import CollectionChatMessage as DBCollectionChatMessage
