...
async def terminal_websocket(
    ...
    try:
        from app.api.v1.deepspace_chats import _authenticate_websocket_auth_context
        ...
        from app.services.deepspace.workspace.qsat_predictor import QSATPredictor
        qsat = QSATPredictor(workspace_path=workspace_path)

        session_id = websocket.query_params.get("session_id", "default")

        from app.services.deepspace.workspace.shell_manager import ShellManager
