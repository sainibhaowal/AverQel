...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "is_local", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "supports_chat",
            sa.Boolean(),
    ...
    op.create_index(
        "ix_provider_configs_workspace_id", "provider_configs", ["workspace_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_provider_model_cache_tenant_id", "provider_model_cache", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_provider_assignments_tenant_id", "provider_assignments", ["tenant_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_provider_health_checks_tenant_id", "provider_health_checks", ["tenant_id"]
    )
    op.create_index(
        "ix_provider_health_checks_status", "provider_health_checks", ["status"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_provider_usage_records_tenant_id", "provider_usage_records", ["tenant_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_provider_usage_records_operation", "provider_usage_records", ["operation"]
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_provider_usage_records_created_at", table_name="provider_usage_records"
    )
    op.drop_index(
        "ix_provider_usage_records_operation", table_name="provider_usage_records"
    )
    op.drop_index(
        "ix_provider_usage_records_provider_config_id",
    ...
    op.drop_index(
        "ix_provider_usage_records_tenant_id", table_name="provider_usage_records"
    )
    op.drop_table("provider_usage_records")

    op.drop_index(
        "ix_provider_health_checks_checked_at", table_name="provider_health_checks"
    )
    op.drop_index(
        "ix_provider_health_checks_status", table_name="provider_health_checks"
    )
    op.drop_index(
        "ix_provider_health_checks_tenant_id", table_name="provider_health_checks"
    )
    op.drop_index(
        "ix_provider_health_checks_provider_config_id",
    ...
    op.drop_index(
        "ix_provider_assignments_provider_config_id", table_name="provider_assignments"
    )
    op.drop_index(
        "ix_provider_assignments_feature_scope", table_name="provider_assignments"
    )
    op.drop_index(
        "ix_provider_assignments_workspace_id", table_name="provider_assignments"
    )
    op.drop_index(
        "ix_provider_assignments_tenant_id", table_name="provider_assignments"
    )
    op.drop_table("provider_assignments")

    op.drop_index(
        "ix_provider_model_cache_tenant_id", table_name="provider_model_cache"
    )
    op.drop_index(
        "ix_provider_model_cache_provider_config_id", table_name="provider_model_cache"
    )
    op.drop_table("provider_model_cache")

    op.drop_index("ix_provider_secrets_tenant_id", table_name="provider_secrets")
    op.drop_index(
        "ix_provider_secrets_provider_config_id", table_name="provider_secrets"
    )
